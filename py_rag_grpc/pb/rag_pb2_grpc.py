...
class RagServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.AddRag = channel.unary_unary(
                '/rag.RagService/AddRag',
        ...
        self.SearchRag = channel.unary_unary(
                '/rag.RagService/SearchRag',
                request_serializer=rag__pb2.RagSearchRequest.SerializeToString,
                response_deserializer=rag__pb2.RagSearchResponse.FromString,
                _registered_method=True)
...
def add_RagServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AddRag': grpc.unary_unary_rpc_method_handler(
                    servicer.AddRag,
            ...
            'SearchRag': grpc.unary_unary_rpc_method_handler(
                    servicer.SearchRag,
                    request_deserializer=rag__pb2.RagSearchRequest.FromString,
                    response_serializer=rag__pb2.RagSearchResponse.SerializeToString,
            ),
    }
...
class RagService(object):
    ...
    def SearchRag(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/rag.RagService/SearchRag',
            rag__pb2.RagSearchRequest.SerializeToString,
            rag__pb2.RagSearchResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
